local Sorted, SortDown = CreateClientConVar("FAdmin_SortPlayerList", "Name", true), CreateClientConVar("FAdmin_SortPlayerListDown", 1, true)
local allowedSorts = {
    ["Name"] = true,
    ["Frags"] = true,
    ["Deaths"] = true,
...
function FAdmin.ScoreBoard.Main.Show()
    ...
    sortBy = allowedSorts[sortBy] and sortBy or "Name"
